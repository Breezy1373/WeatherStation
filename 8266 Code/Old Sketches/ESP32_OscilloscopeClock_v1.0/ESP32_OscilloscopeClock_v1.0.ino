...
#define NTP
  ...
  NTPtime NTPch("us.pool.ntp.org"); // Choose your server pool
  char *ssid      = "Dog Food II";        // Set you WiFi SSID
  char *password  = "Silentd3$";        // Set you WiFi password
...
void setup() 
{
  ...
  if (h > 12) h=h-12;
    ...
    if (Timeout!=0){
      ...
      dateTime = NTPch.getNTPtime(18.0, 18);
      Timeout=20;
